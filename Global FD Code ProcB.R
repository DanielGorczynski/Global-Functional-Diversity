...
### increases with productivity and larger species pools ###
...
model.FDis <- brm(formula = Fdis ~ FPoolRich + Landcover.div + ndvi + FR.Lost + hum.dens.ZOI + Africa + Asia + Madagascar + Neotropics - 1, 
                  data = dat,  control = list(adapt_delta = 0.999, max_treedepth = 20), family = "weibull", iter = 4000)

model.FDisUW <- brm(formula = FDisUW ~ FPoolRich + Landcover.div + ndvi + hum.dens.ZOI + FR.Lost + Africa + Asia + Madagascar + Neotropics - 1, 
             data    = dat,  control = list(adapt_delta = 0.999, max_treedepth = 20), iter = 4000)

model.FDisSPUW <- brm(formula = FDisSPUW ~ FPoolRich + Landcover.div + ndvi + hum.dens.ZOI + FR.Lost + Africa + Asia + Madagascar + Neotropics - 1, 
                      data    = dat,  control = list(adapt_delta = 0.999, max_treedepth = 20), iter = 4000)
...
spp.pool.traits <- read.csv("~/Documents/TEAM_functional_diversity/Full trait list bi 1 kg.csv", row.names = 1)
spp.pool.traits$Body.Mass <- log(spp.pool.traits$Body.Mass)
spp.pool.traits$Litter.Size <- log(spp.pool.traits$Litter.Size)
...
BBS.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/BBS/BBS Community traits.csv")
BCI.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/BCI/BCI Community traits.csv")
BIF.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/BIF/BIF Community traits.csv")
CAX.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/CAX/CAX Community traits.csv")
COU.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/COU/COU Community traits.csv")
CSN.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/CSN/CSN Community traits.csv")
KRP.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/KRP/KRP Community traits.csv")
NAK.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/NAK/NAK Community traits.csv")
NNN.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/NNN/NNN Community traits.csv")
PSH.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/PSH/PSH Community traits.csv")
RNF.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/RNF/RNF Community traits.csv")
UDZ.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/UDZ/UDZ Community traits.csv")
VB.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/VB/VB Community traits.csv")
YAN.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/YAN/YAN Community traits.csv")
YAS.Community.traits <- read.csv("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/YAS/YAS Community traits.csv")
...
rgl.open()
rgl.bg(color = "white")
plot(site.conv, color = "#FF6600", alpha = 0.35) 
...
for (i in 1:length(file.list)){
  fgdb = paste0("~/Documents/TEAM_functional_diversity/Site Trait and Occ data/", file.list[i],"/",file.list[i]," spp pool.csv")
...
Species <- Species[-1,]
All.TEAM.Occupancy <- read.csv("~/Documents/TEAM_functional_diversity/TEAM site occurences- REDO/All TEAM Occupancy.csv")
...
rgl.open()
rgl.bg(color = "white")
plot(site.conv, color = "#345ECE", alpha = 0.35) ###
...
Site.Coords <- read.csv("~/Documents/TEAM_functional_diversity/Figures/Site Coords.csv")
...
#colfunc <- colorRampPalette(c('purple4','blue','green','yellow','orange','red'))
